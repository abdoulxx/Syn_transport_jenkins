...
target_url = 'https://syn-transport.com'
...
def set_include_in_context():
    exclude_url = 'https://syn-transport.com/deconnexion.php'
    include_url = 'https://syn-transport.com/.*'  
...
def set_form_based_auth():
    login_url = 'https://syn-transport.com/connexion.php'
...
def set_user_auth_config():
    user = 'sidy samb'
    username = 'aboulayesamb@gmail.com'
    password = '123'
